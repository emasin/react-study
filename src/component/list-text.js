...
class ListText extends React.Component {
    render(){
        return (
            <>
                <div className="">
                    <h4 className="subtit">유창한 영어의 기본요소</h4>
                    <p className="subtxt">유창한 영어로 대화하며 자신감을 키워보세요. 간단한 대화부터 복잡한 시사 문제에 대해 논리정연한 의견을 표현하는 것까지, 다양한 레벨의 과정을 통해 모두가 무언가를 배울 수 있습니다.</p>
                </div>
                {/*<div>
